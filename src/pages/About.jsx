...
const cards = [
  {
    img: IMG6,
    title: "Food and Beverage Exhibition",
...
function About() {
  return (
    <div className="h-full px-4 py-8 sm:px-8 bg-gray-100" id="About">
      {/* About Section */}
      <div className="p-6 flex flex-col lg:flex-row justify-between gap-8 ">
        ...
        <motion.div
          ...
          <a href="#Book"><button className="bg-black hover:bg-gray-800 text-white py-2 px-4 rounded-full mb-6 transition-all">
            Book Your Event
          </button></a>
        </motion.div>
      </div>
          ...
          {cards.map((card, index) => (
            <motion.div
              ...
              <div className="relative z-10 flex flex-col justify-end h-full p-4 rounded-2xl">
                ...
                <p className="text-gray-100">{card.message}</p>
              </div>
            </motion.div>
          ))}
        </div>
